...
intro_tab <- tabPanel(
  ...
  fluidPage(theme = bs_theme(bootswatch = "sketchy"),
    ...
    # HTML('<img src="https://th.bing.com/th/id/OIP.aZzzazc5lx7Dbx_neX5pmAHaE8?w=280&h=187&c=7&r=0&o=5&dpr=1.5&pid=1.7"alt="Many people get a high school diploma, but why do many not?"')
    )
)
